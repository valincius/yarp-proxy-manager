            ...
            <For each={hosts()}>
              {(host) => (
                <tr class="border-b border-slate-100 last:border-0 hover:bg-slate-50">
                  <td data-label="Name" class="px-4 py-3 font-medium text-slate-800">{host.name}</td>
                  <td data-label="Domains" class="px-4 py-3 text-slate-600">{host.domainNames.join(', ')}</td>
                  <td data-label="Destination" class="px-4 py-3 text-slate-600">
